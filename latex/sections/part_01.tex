...
The steady state and critical levels for all scenarios are summarized in table \ref{tab:crosstalk_results}. Below, on figure \ref(fig:microstrip_voltage_curve) a visual representation of influence of the crosstalk on the victim line is shown.
